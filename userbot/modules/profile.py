...
@bot.on(ayiin_cmd(outgoing=True, pattern=r"reserved$"))
...
@bot.on(ayiin_cmd(outgoing=True, pattern=r"name"))
...
@bot.on(ayiin_cmd(outgoing=True, pattern=r"setpfp$"))
...
@bot.on(ayiin_cmd(outgoing=True, pattern=r"setbio (.*)"))
...
@bot.on(ayiin_cmd(outgoing=True, pattern=r"username (.*)"))
...
@bot.on(ayiin_cmd(outgoing=True, pattern=r"count$"))
...
@bot.on(ayiin_cmd(outgoing=True, pattern=r"delpfp"))
...
@bot.on(ayiin_cmd(pattern=r"info(?: |$)(.*)", outgoing=True))
async def who(event):
