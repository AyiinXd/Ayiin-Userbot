...
async def amireallyalive(alive):
    ...
    output = (
        f"**[Ayiin-Userbot](https://github.com/AyiinXd/Ayiin-Userbot) Aktif Tod.**\n\n"
        f"**{alive_text}**\n\n"
        ...
        f"    **[𝗦𝘂𝗽𝗽𝗼𝗿𝘁](https://t.me/XhamsterId{GROUP})** | **[𝗖𝗵𝗮𝗻𝗻𝗲𝗹](https://t.me/{CHANNEL})** | **[𝗢𝘄𝗻𝗲𝗿](tg://user?id={user.id})**"
    )
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
