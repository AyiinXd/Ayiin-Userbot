...
async def sketch(e):
    ...
    await xx.respond("⍟ __Sketsa Hasilkan oleh Ayiin-Userbot__ ⍟", file="ayiinxd.png")
    await xx.delete()
    os.remove(file)
...
async def pixelator(event):
    ...
    await yins.respond("⍟ __Pixelator Dihasilkan oleh Ayiin-Userbot__ ⍟", file="output.jpg")
    await yins.delete()
