...
async def _(a):
    ayiin = await a.edit("`Pertama-tama kamu cantik`")
    sleep(2)
...
async def _(y):
    ayiin = await y.edit("**Lah, Lu tolol?**")
    sleep(2)
...
async def _(i):
    ayiin = await i.edit("**Wahh, War nya keren bang**")
    sleep(2)
...
async def _(n):
    ayiin = await n.edit("eh kamu, iya kamu")
    sleep(2)
    await ayiin.edit("**ALAY bnget sih**")
    sleep(2)
    await ayiin.edit("**spam bot mulu**")
    sleep(2)
    await ayiin.edit("**baru pande bikin userbot ya?? xixixi**")
    sleep(2)
...
async def _(x):
    ayiin = await x.edit("Hai, Kamu Anak Erpe Ya")
    sleep(2)
...
async def _(d):
    ayiin = await d.edit("**OI ANAK TITLE**")
    sleep(2)
